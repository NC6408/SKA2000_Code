/**
  ******************************************************************************
  * @file       : SKA_HoistUnitTrackingController.h
  * @brief      : 起升机构的跟踪控制器
  * @author     : ZhangYi
  * @version    : None
  * @date       : 2024/10/24
...
#ifndef SKA2000_OHBC_CONTROLLER_SKA_HOISTUNITTRACKINGCONTROLLER_H
#define SKA2000_OHBC_CONTROLLER_SKA_HOISTUNITTRACKINGCONTROLLER_H
...
typedef struct {
    ...
    double dVp;                             // 比例环节输出
    double dVi;                             // 积分环节输出
} SKA_HoistUnitTrackingController;
...
#endif //SKA2000_OHBC_CONTROLLER_SKA_HOISTUNITTRACKINGCONTROLLER_H
